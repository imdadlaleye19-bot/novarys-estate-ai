    ...
    <div className="min-h-screen bg-background lg:flex">
      ...
      >
        ...
        <div className="absolute inset-x-3 bottom-4 space-y-3">
          <div className="border-t border-sidebar-foreground/15 pt-3">
            <Link
              to="/admin/overview"
              onClick={() => setOpen(false)}
              activeProps={{ className: "bg-sidebar-accent text-sidebar-accent-foreground" }}
              className="flex items-center gap-3 rounded-md px-3 py-2 text-xs opacity-60 transition-colors hover:bg-sidebar-accent hover:opacity-100"
            >
